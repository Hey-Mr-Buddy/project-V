...
export const getCurrentUser = query({
  handler: async (ctx) => {
    ...
    if (!user) {
      // This can happen if the user is authenticated with Clerk
      // but the `storeUser` mutation hasn't completed yet.
      // Returning null here is safe, the UI will update once the user is stored.
      return null;
    }
