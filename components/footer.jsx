  ...
  return (
    <footer className="border-t border-gray-800/50 py-8 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-6 text-sm text-gray-400">
        Made with ❤️ by VictoRizz for Victors
      </div>

      <div className="flex gap-4 items-center">
        <a
          href="https://www.instagram.com/victorizz_india/"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/company/victorizz/"
          target="_blank"
          className="text-gray-400"
        >
          <Linkedin />
        </a>
        <a href="https://www.instagram.com/victorizz_football/"
          target="_blank"
          className="text-gray-400"
        >
          <Instagram className="w-5 h-5" />
